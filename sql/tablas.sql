...
create table c_moyote
(
	folio_moyote INTEGER
		constraint c_moyote_pk
			primary key
		references moyote,
	ciclos_hasta_parir INTEGER default null,
	tanque_moyote real default 0.01
);
...
(
	...
	fecha_muerte integer default null
);
...
create table persona_area_recreativa
(
	folio_persona INTEGER not null
		constraint persona_area_recreativa_pk
			primary key
		references persona,
	folio_area INTEGER not null
		references area
